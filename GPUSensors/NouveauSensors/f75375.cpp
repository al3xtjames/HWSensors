...
int f75375_get_gpu_temp(nouveau_device *device)
{
    ...
    xf86I2CReadByte(device->nvclock_i2c_sensor, F75375S_TEMP_GPU, &nvh);
    return (int)nvh;
}
...
int f75375_get_fanspeed_rpm(nouveau_device *device)
{
    ...
    xf86I2CReadByte(device->nvclock_i2c_sensor, F75375S_FAN1_COUNT_H, &nvh);
    xf86I2CReadByte(device->nvclock_i2c_sensor, F75375S_FAN1_COUNT_L, &nvl);
...
int f75375_get_board_temp(nouveau_device *device)
{
    ...
    xf86I2CReadByte(device->nvclock_i2c_sensor, F75375S_TEMP_RAM, &nvh);
    return (int)nvh;
}
...
int f75375_get_fanspeed_pwm(nouveau_device *device)
{
    ...
    xf86I2CReadByte(device->nvclock_i2c_sensor, F75375S_FAN1_PWM, &speed);
